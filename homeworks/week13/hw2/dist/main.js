...
function init(options) {
  ...
  var commentDOM = jquery__WEBPACK_IMPORTED_MODULE_0___default()(commentsSelector);
  getNewComments();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(commentsSelector).on('click', '.' + loadMoreClassName, function () {
    getNewComments();
  });
  ...
  function getNewComments() {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_1__.getComments)(apiUrl, siteKey, lastId, function (data) {
      ...
      if (comments.length === 0) {
        ...
        var loadMoreButtonHTML = (0,_templates__WEBPACK_IMPORTED_MODULE_3__.getLoadMoreButton)(loadMoreClassName);
